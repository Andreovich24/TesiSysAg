...
import attention_vggface2.attention.attention as attention_module


class VGGFace2AM(nn.Module):

    def __init__(self, classes=7):
        super(VGGFace2AM, self).__init__()
        ...
        self.am1 = attention_module.AttentionBlock(64 * self.block_expansion)
        self.am2 = attention_module.AttentionBlock(128 * self.block_expansion)
        self.am3 = attention_module.AttentionBlock(256 * self.block_expansion)
    ...
    def forward(self, data):
        ...
        # conv2_1 = torch.add(conv2_1_1x1_proj_bn, conv2_1_1x1_increase_bn, alpha=1)
        ...
        am1x = self.am1(conv2_3x)

        conv3_1_1x1_reduce = self.vggface2.vggface2.conv3_1_1x1_reduce(am1x)
        ...
        conv3_1_1x1_proj = self.vggface2.vggface2.conv3_1_1x1_proj(am1x)
        ...
        am2x = self.am2(conv3_4x)

        conv4_1_1x1_reduce = self.vggface2.vggface2.conv4_1_1x1_reduce(am2x)
        ...
        conv4_1_1x1_proj = self.vggface2.vggface2.conv4_1_1x1_proj(am2x)
        ...
        am3x = self.am3(conv4_6x)

        conv5_1_1x1_reduce = self.vggface2.vggface2.conv5_1_1x1_reduce(am3x)
        ...
        conv5_1_1x1_proj = self.vggface2.vggface2.conv5_1_1x1_proj(am3x)
...
if __name__ == "__main__":
    ...
    model.eval()
    with torch.no_grad():
        out = model(transforms.ToTensor()(x).unsqueeze_(0).to(device))
        print(out)