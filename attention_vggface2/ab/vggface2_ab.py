...
import attention_vggface2.ab.ab as ab_module


class VGGFace2AB(nn.Module):

    def __init__(self):
        super().__init__()
        self.block_expansion = 4
        self.vggface2 = model.VGGFace2(pretrained=True)
        self.ab1 = ab_module.AB(64 * self.block_expansion)
        self.ab2 = ab_module.AB(128 * self.block_expansion)
        self.ab3 = ab_module.AB(256 * self.block_expansion)
    ...
    def forward(self, data):
        ...
        ab1x = self.ab1(conv2_3x)

        conv3_1_1x1_reduce = self.vggface2.vggface2.conv3_1_1x1_reduce(ab1x)
        ...
        conv3_1_1x1_proj = self.vggface2.vggface2.conv3_1_1x1_proj(ab1x)
        ...
        ab2x = self.ab2(conv3_4x)

        conv4_1_1x1_reduce = self.vggface2.vggface2.conv4_1_1x1_reduce(ab2x)
        ...
        conv4_1_1x1_proj = self.vggface2.vggface2.conv4_1_1x1_proj(ab2x)
        ...
        ab3x = self.ab3(conv4_6x)

        conv5_1_1x1_reduce = self.vggface2.vggface2.conv5_1_1x1_reduce(ab3x)
        ...
        conv5_1_1x1_proj = self.vggface2.vggface2.conv5_1_1x1_proj(ab3x)
