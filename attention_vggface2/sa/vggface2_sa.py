...
import attention_vggface2.sa.scsa as sa_module


class VGGFace2SA(nn.Module):

    def __init__(self, classes=7):
        super().__init__()
        self.block_expansion = 4
        self.vggface2 = model.VGGFace2(pretrained=True, classes=classes)
        self.sa1 = sa_module.SelfAttention(64 * self.block_expansion)
        self.sa2 = sa_module.SelfAttention(128 * self.block_expansion)
        self.sa3 = sa_module.SelfAttention(256 * self.block_expansion)
    ...
    def forward(self, data):
        ...
        sa1x = self.sa1(conv2_3x)

        conv3_1_1x1_reduce = self.vggface2.vggface2.conv3_1_1x1_reduce(sa1x)
        ...
        conv3_1_1x1_proj = self.vggface2.vggface2.conv3_1_1x1_proj(sa1x)
        ...
        sa2x = self.sa2(conv3_4x)

        conv4_1_1x1_reduce = self.vggface2.vggface2.conv4_1_1x1_reduce(sa2x)
        ...
        conv4_1_1x1_proj = self.vggface2.vggface2.conv4_1_1x1_proj(sa2x)
        ...
        sa3x = self.sa3(conv4_6x)

        conv5_1_1x1_reduce = self.vggface2.vggface2.conv5_1_1x1_reduce(sa3x)
        ...
        conv5_1_1x1_proj = self.vggface2.vggface2.conv5_1_1x1_proj(sa3x)
