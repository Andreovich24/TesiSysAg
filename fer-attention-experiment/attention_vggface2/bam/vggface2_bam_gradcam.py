...
import attention_vggface2.bam.bam as bam_module


class VGGFace2BAMGradCAM(nn.Module):

    def __init__(self):
        super().__init__()
        self.block_expansion = 4
        self.vggface2 = model.VGGFace2(pretrained=True)
        self.bam1 = bam_module.BAM(64 * self.block_expansion)
        self.bam2 = bam_module.BAM(128 * self.block_expansion)
        self.bam3 = bam_module.BAM(256 * self.block_expansion)
    ...
    def forward(self, data):
        ...
        bam1x = self.bam1(conv2_3x)

        conv3_1_1x1_reduce = self.vggface2.vggface2.conv3_1_1x1_reduce(bam1x)
        ...
        conv3_1_1x1_proj = self.vggface2.vggface2.conv3_1_1x1_proj(bam1x)
        ...
        bam2x = self.bam2(conv3_4x)

        conv4_1_1x1_reduce = self.vggface2.vggface2.conv4_1_1x1_reduce(bam2x)
        ...
        conv4_1_1x1_proj = self.vggface2.vggface2.conv4_1_1x1_proj(bam2x)
        ...
        bam3x = self.bam3(conv4_6x)

        conv5_1_1x1_reduce = self.vggface2.vggface2.conv5_1_1x1_reduce(bam3x)
        ...
        conv5_1_1x1_proj = self.vggface2.vggface2.conv5_1_1x1_proj(bam3x)
