...
parser.add_argument("-d", "--dataset", type=str, default="fer2013", choices=["fer2013", "fer2013clean", "rafdb", "rafdbaligned", "affectnet", "ferplus", "ferplus8", "elfemplus", "rafdbfer2013", "valrafdb-fer2013", "rafdb-valfer2013", "rafdb-testfer2013", "viv", "fer2013mask", "fer2013nomask", "lfw", "mlfw"], help='Chose the dataset')
...
if args.dataset == "rafdb":
    ...
    test_data = LFW(split="val", masked=False, transform=test_preprocess)
    label_mapping = {0: "Neutral",
                     1: "Negative",
                     2: "Positive"}
    classes = 3
elif args.dataset == "mlfw":
    test_data = LFW(split="val", masked=True, transform=test_preprocess)
    label_mapping = {0: "Neutral",
                     1: "Negative",
                     2: "Positive"}
    classes = 3
