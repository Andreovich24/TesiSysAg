...
class FER2013Mask(data.Dataset):
    ...
    def __init__(self, split='train', masked=True, transform=None, as_rgb=False):
    ...
    def __getitem__(self, idx):
        ...
        if self.masked is True:
            ...
            #y = round((lds[2][1]+lds[14][1])/2)  il punto medi tra il punto 2 e 14 per colonne

            w = lds[14][0] - x
            h = min(lds[6][1], lds[10][1]) - y
